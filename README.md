# Hola, soy Gonzalo Aguirre 

**Data Analyst | Business Intelligence | Analista Funcional**
📍 Córdoba, Argentina
...
| Área | Herramientas |
|---|---|
| **Bases de datos** | SQL (Joins, CTEs, Subconsultas) |
| **Visualización & BI** | Power BI, Power Query |
| **Análisis & automatización** | Python, Jupyter Notebook, Pandas |
| **Datos tabulares** | Excel avanzado |
...
- Participación en el área de **chatbot ciudadano**: control de calidad, entrenamiento del sistema y validación de respuestas
...
|---|---|---|
| [observatorio](https://github.com/Gonzalo-Aguirre/observatorio) | Análisis de transporte público — reportes, KPIs y ETL | Python, SQL, Power BI |
| [municipalidad](https://github.com/Gonzalo-Aguirre/municipalidad) | Proyectos de datos para Ciudad Inteligente | SQL, Análisis Funcional |
